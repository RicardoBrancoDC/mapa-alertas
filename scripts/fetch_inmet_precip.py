...
ENTITIES_URL = os.getenv('INMET_ENTIDADES_URL', 'https://apimapas.inmet.gov.br/entidades')
...
def get_all_entity_ids() -> list[str]:
    response = requests.get(ENTITIES_URL, headers=BROWSER_HEADERS, timeout=TIMEOUT_SEC)
...
def run_browser_capture() -> tuple[dict[str, Any], dict[str, Any]]:
    with sync_playwright() as p:
        ...
        page.goto(MAP_URL, wait_until='domcontentloaded', timeout=TIMEOUT_SEC * 1000)
